...
CREATE TABLE current_package_versions (
	...
	package_id INT UNSINED NOT NULL UNIQUE,
...
CREATE TABLE host_package_versions (
	...
	CONSTRAINT FOREIGN KEY hpv_pacakge_history_id_foreign_key (package_history_id) REFERENCES package_history(id) ON DELETE CASCADE ON UPDATE CASCADE);

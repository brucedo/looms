...
looms set.  The lib module should be on the natural search path of the python 2.7 interpreter on the host system,
...
# can import the lib module of an existing install to determine what changes may need to be made to the db schema
